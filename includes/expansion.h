...
/*   Updated: 2023/09/20 05:34:18 by hsawamur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			expand_redirect_list(t_redirect_list **redirect_list, \
										t_data *d);
char			*expand_convert_dollar_word(char **word, char **type, \
										t_data *d);
void			expand_get_expanded_token(char **token, char **type, \
										t_data *d);
...
bool			expand_is_word_splitting(char *word, char *type, \
											char *ifs, size_t i);
...
void			expand_word_splitting_word_list(t_word_list *n,
...
void			expand_word_splitting_not_ifs_default(t_word_list **n,
					t_word_list **p, t_word_list **head, char *ifs);
